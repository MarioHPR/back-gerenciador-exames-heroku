...
public class DadosConsultaRequest {
    ...
    public DadosConsultaRequest(String nomeMedico, LocalDate dataConsulta, String diagnostico, String prescricao, String linkImage, DadosInstituicaoRequest dadosInstituicao) {
